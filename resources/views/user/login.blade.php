                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                <div class="form-group">
                                    <input type="text" ng-model="email" ng-click="sua()" class="form-control form-control-user"
                                ...
                                <a href="#" ng-click="dangnhap(email,password)" class="btn btn-primary btn-user btn-block">
                                    Đăng nhập
                                </a>
                                <hr>
