               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            <a href="#" class="nav-link"><i class="flaticon-classmates"></i><span>Admin</span></a>
                            <ul class="nav sub-group-menu  sub-group-active">
                                <li class="nav-item">
                                    <a href="/admin/products" class="nav-link"><i class="fas fa-angle-right"></i>Product</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/categories" class="nav-link"><i class="fas fa-angle-right"></i>Category</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/staff" class="nav-link"><i class="fas fa-angle-right"></i>Staff</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/supplier" class="nav-link"><i class="fas fa-angle-right"></i>Supplier</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/news" class="nav-link"><i class="fas fa-angle-right"></i>New</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/slides" class="nav-link"><i class="fas fa-angle-right"></i>Slides</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                <li class="nav-item">
                                    <a href="/admin/customer" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Customer</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/userss" class="nav-link"><i class="fas fa-angle-right"></i>User</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/bills" class="nav-link"><i class="fas fa-angle-right"></i>Bill bán</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/admin/billsnhap" class="nav-link"><i class="fas fa-angle-right"></i>Bill nhập</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item sidebar-nav-item">
