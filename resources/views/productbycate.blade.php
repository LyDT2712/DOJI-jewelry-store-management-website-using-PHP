        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-7">
                    ...
                    <div class="row" >
                        <div class="col-lg-4 col-md-6 col-sm-6" dir-paginate="sp in lstcate|orderBy:sortBy:isASC|filter:timkiem|itemsPerPage:itemPerPage">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a ng-click="openDetails(sp.id)" href="/detail"><lable class="product-name">@{{sp.name}}</a></h6>
