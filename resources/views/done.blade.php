...
<body>
    ...
    <div style="text-align:center">
        <a style="font-size: 40px; color:red">BẠN ĐÃ ĐẶT HÀNG THÀNH CÔNG!!!</a><br>
        <a style="font-size: 40px; color:red">BẠN SẼ SỚM NHẬN ĐƯỢC HÀNG!!!</a><br>
        <a style="font-size: 40px; color:red">DOJI_XIN CẢM ƠN!!!</a><br>
    </div>
