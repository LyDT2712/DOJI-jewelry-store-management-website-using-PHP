<!doctype html>
<html class="no-js" lang="" ng-app="myapp" ng-controller="nhacungcapcontroller">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" ng-model="nhaccs.diachi_ncc">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" ng-model="nhaccs.Delet">
                                            </div>
                                        </div>
                                    </div>
