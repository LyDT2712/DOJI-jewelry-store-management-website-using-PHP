<!doctype html>
<html class="no-js" lang="" ng-app="myapp" ng-controller="newscontroller">
            ...
            <div class="card height-auto" style="width: 90%;">
                <div class="card-body">
                        ...
                        <div class="table-responsive" >
                            ...
                            <tbody>
                                <tr dir-paginate="b in news|filter:timkiem|itemsPerPage:itemPerPage">
                                    <td>@{{$index+serial}}</td>
                                    <td>@{{b.title}}</td>
                                    <td>@{{b.content}}</td>
                                    <td><img src="/assets/images/@{{b.image}}" style='width:100px' alt=""></td>
                                    <td>@{{b.created_at}}</td>
                                    <td>@{{b.update_at}}</td>
                                    <td><button class="btn btn-info fa fa-pencil" ng-click="showmodal(b.id_new)">&nbsp;</button></td>
                                    <td><button class="btn btn-danger fa fa-trash" ng-click="deleteClick(b.id_new)">&nbsp;</button></td>
                                </tr>
                            </tbody>
                        </table>
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" ng-model="new.content">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    ...
                                                    <label class="custom-file-label" class="form-control" id='img' for="customFile" >@{{new.image}}</label>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
