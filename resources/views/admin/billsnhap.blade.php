<!doctype html>
<html class="no-js" lang="" ng-app="myapp" ng-controller="billsbancontroller">
...
<body>
    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <tbody>
                <tr ng-repeat="bn in nhaps|filter:timkiem|itemsPerPage:itemPerPage">
                    <td>@{{$index+1}}</td>
                    <td>@{{bn.id_ncc}}</td>
                    ...
                    <td>@{{bn.note}}</td>
                    <td>@{{bn.created_at}}</td>
                    <td><button class="btn btn-info fa fa-pencil" ng-click="showmodal(bn.id)">Edit</button></button></td>
                    <td><button class="btn btn-danger fa fa-trash" ng-click="deleteClick(bn.id)">Delete</button></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<label for="name">ID NCC:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="nhap.id_ncc">
</div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="nhap.id_nhanvien">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="nhap.date_order">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="nhap.tong_tien">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="nhap.thanh_toan">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="nhap.note">
                            </div>
                        </div>
                    </div>
                </div>
