<!doctype html>
<html class="no-js" lang="" ng-app="myapp" ng-controller="khachhangcontroller">
                        ...
                        <table class="table table-border text-nowrap" >
                            ...
                            <tbody>
                                <tr dir-paginate="kh in customer|filter:timkiem|itemsPerPage:itemPerPage">
                                    ...
                                    <td >@{{kh.sdt}}</td>
                                    <td >@{{kh.note}}</td>
                                    <td><button class="btn btn-info fa fa-pencil" ng-click="showmodal(kh.id)"></button></button></td>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" ng-model="khach.note">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
