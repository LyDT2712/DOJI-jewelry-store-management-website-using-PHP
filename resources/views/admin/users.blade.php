<!doctype html>
<html class="no-js" lang="" ng-app="myapp" ng-controller="userscontroller">
                ...
                <div class="card-body">
                        ...
                        <div class="table-responsive" >
                            <table class="table table-border text-nowrap" >
                                ...
                                <tbody>
                                    <tr  dir-paginate="sp in userss|filter:timkiem|itemsPerPage:itemPerPage">
                                        <td>@{{$index + serial}}</td>
                                        <td>@{{sp.full_name}}</td>
                                        <td>@{{sp.users_name}}</td>
                                        <td>@{{sp.email}}</td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <label for="name">users_name:</label>
                                                    <div>
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" ng-model="users.email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="container-fluid">
                                            ...
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" ng-model="users.Delet">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="container-fluid">
                                                <div class="form-group">
                                                    <label for="name">remember_token:</label>
                                                    <div>
                                                        <input type="text" class="form-control" ng-model="users.remember_token">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
