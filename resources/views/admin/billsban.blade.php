...
<body>
    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <tbody>
                <tr dir-paginate="sp in bills|filter:timkiem|itemsPerPage:itemPerPage">
                    <td>@{{$index+serial}}</td>
                    <td>@{{sp.id_kh}}</td>
                    <td>@{{sp.date_order}}</td>
                    <td>@{{sp.tong_tien| number:0}}đ</td>
                    <td>@{{sp.payment}}</td>
                    <td>@{{sp.status}}</td>
                    <td>@{{sp.note}}</td>
                    <td>@{{sp.created_at}}</td>
                ...
                <div class="modal-body">
                    ...
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="bill.tong_tien">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="bill.payment">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="bill.created_at">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="bill.updated_at">
                            </div>
                        </div>
                    </div>
