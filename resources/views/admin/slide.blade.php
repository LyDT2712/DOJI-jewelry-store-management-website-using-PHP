<!doctype html>
<html class="no-js" lang="" ng-app="myapp" ng-controller="slidecontroller">
                ...
                <div class="card-body">
                        ...
                        <button type="submit" class="fw-btn-fill btn-gradient-yellow" ng-click="showmodal(0)">Thêm mới</button>
                            ...
                            <table class="table table-border text-nowrap" >
                                <thead>
                                    <tr>
                                        ...
                                        <tbody>
                                            <tr dir-paginate="s in slides|orderBy:sortBy:isASC|filter:searchName|itemsPerPage:itemPerPage">
                                                <td>@{{$index+1}}</td>
                                                <td><img src="/assets/images/@{{s.image}}" style='width:100px'></td>
                                                ...
                                                <div class="modal-header">
                                                        <h5 class="modal-title">@{{modalTitle}}</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <ban aria-hidden="true">&times;</ban>
                                                            </button>
                                                    </div>
                            ...
                            <label for="name">image:</label>
                                                        <div>
                                                            <input type="text" class="form-control" ng-model="slide.image">
                                                        </div>
                                                    </div>
